...
public class CameraControl : NetworkBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        transform.rotation = Quaternion.Euler(rotationX/4, rotationY, 0);
        if(torsoPersonagem != null) torsoPersonagem.transform.rotation = Quaternion.Euler(rotationX, rotationY, 0);
